...
/**
 * A preset whose settings are properties. A country's preset sets its date format, which has no default, its currency
 * formats, and whatever else it writes differently from these defaults: a decimal point, commas between groups of
 * three digits, 5.5%, English month names and 1 January 2020 written out.
 */
