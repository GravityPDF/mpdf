...
class PDFA2Test extends \Yoast\PHPUnitPolyfills\TestCases\TestCase
{
	...
	public function testAnnotsListOnlyAnnotations($config)
	{
		...
		$mpdf->compress = false;
		$mpdf->WriteHTML(
			'<p><a href="#b">link</a> <annotation content="Popup" popup="true" /> <annotation content="File" file="' . __FILE__ . '" /> <annotation content="Plain" /></p>'
	...
	public function testPdfa2EmbedsOnlyPdfaFiles()
	{
		...
		$mpdf = $this->pdfa('2-B', ['allowAnnotationFiles' => true, 'PDFAauto' => false]);
	...
	public function testPdfa2AutoLeavesOutFileItCannotEmbed()
	{
		...
		$mpdf = $this->pdfa('2-B', ['allowAnnotationFiles' => true]);
