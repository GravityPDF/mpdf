...
trait InvoiceFixtures
{
	...
	private function shopInvoice()
	{
		...
		return $invoice->setPrepaidAmount($invoice->getTotals()->getGrandTotal());
	}
	...
	/**
	 * A writer whose output is the one given
	 *
	 * @param \Mpdf\Invoice\Output\OutputInterface $output
	 *
	 * @return \Mpdf\Invoice\WriterInterface
	 */
	private function writerOf(OutputInterface $output)
	{
