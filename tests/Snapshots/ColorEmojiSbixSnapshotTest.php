...
/**
 * Colour emoji from an sbix font, drawn as Type3 fonts: a face, a heart asking for colour, a ZWJ family,
 * a flag, a keycap, a skin tone and the flag of England, beside DejaVu text, at two sizes and justified.
 * The last paragraph draws the woman ('dupe'), the girl (a JPEG) and the regional indicator U (a
 * 'flip' of the thumb).
 *
 * @group snapshot
 */
class ColorEmojiSbixSnapshotTest extends Snapshot
{
	...
	public function generatePdf()
	{
		$this->mpdf = $this->createMpdf([
			...
			'fontdata' => ['sbix' => ['R' => 'TestEmoji-sbix.ttf', 'useOTL' => 0xFF]],
